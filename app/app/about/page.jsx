                ...
                <div class="row lg-marg">
                    <div class="col-lg-5 valign">
                        <div class="profile-img">
                            <div class="img">
                                <img src="assets/imgs/header/me.jpg" alt="" />
                            </div>
                            <span class="icon">
                    ...
                    <div class="col-lg-7 valign">
                        <div class="cont">
                            ...
                            <div class="text">
                                <h4 class="mb-30">I am <span class="main-color">a Creative Software
                                        Engineer</span> from Nigeria, working in web development and Software
                                    Deployment.</h4>
                                <p>I enjoy turning complex problems into simple, beautiful and intuitive designs. My aim
                                    ...
                                    Applications for many famous brand/startup companies.</p>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="item d-flex align-items-center sm-mb30">
                                                ...
                                                <div>
                                                    ...
                                                    <h6>clarksonlawson1@Gmail.com</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item md-mb30">
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <div>
                                    <h6 class="fz-18">.NET Framework</h6>
                                </div>
                            </div>
                            <div class="skill-progress">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <div>
                                    <h6 class="fz-18">Web Applications</h6>
                                </div>
                            </div>
                            <div class="skill-progress">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="item text-center">
                                        ...
                                        <span class="opacity-8 fw-500 mt-10">[ at Gbuzz ]</span>
